...
var fm = (function () {
	...
	function sendFeedback(event) {
		...
		$.ajax({
			...
			data: { _csrf: fm_options.csrf, name: $("#feedback_name").val(), message: $("#feedback_message").val(), email: $("#feedback_email").val(), radio_list_value: $("#feedback_me_form input[name=feedback_radio]:checked").val()},
